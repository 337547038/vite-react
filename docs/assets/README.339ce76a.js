...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("89CU7N");let t=a.className;a.className.indexOf("show")!==-1?t=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(t=a.className.replace("hide","show")),a.className=t}})))),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:`<h2 id="api">API</h2>
