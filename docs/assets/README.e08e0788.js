...
`}}),a.createElement("div",{className:"control-block"},a.createElement("span",{onClick:()=>{const s=document.getElementById("3J77LX");let e=s.className;s.className.indexOf("show")!==-1?e=s.className.replace("show","hide"):s.className.indexOf("hide")!==-1&&(e=s.className.replace("hide","show")),s.className=e}})))),a.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:`<h2 id="api">API</h2>
