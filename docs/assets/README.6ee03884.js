import{r as j,R as s,u as S,a as u,c as g,p as q,j as F}from"./index.be43aed1.js";import{o as I}from"./index.4eedf3c9.js";import{T as L}from"./Tooltip.11f4e53c.js";import{C as T}from"./CSSTransition.5925e810.js";import{S as H}from"./Switch.e111457f.js";import"./dom.46b1a4a1.js";import"./contextForm.5ae3f644.js";const i=l=>{const{mode:n="vertical",trigger:e="hover",theme:o="light",liHeight:C=40}=l,[h,m]=j.exports.useState(l.openKeys||[]),r=s.useRef(h),[f,N]=j.exports.useState(l.selectedKey||""),B=S(),w=a=>{E(a,!0)},_=a=>{E(a,!1)},E=(a,c)=>{(e==="hover"&&n==="horizontal"||n==="vertical"&&l.collapse)&&x(a,c)},D=(a,c)=>{var p;a.disabled||((e==="click"||n==="vertical")&&x(a,!((p=r.current)!=null&&p.includes(a.key))),a.children||(N(a.key),l.onSelect&&l.onSelect(a),l.router&&B(a.key)),l.onClick&&l.onClick(a),c.stopPropagation())},x=(a,c)=>{var p;a.disabled||(c?a.children&&!((p=r.current)!=null&&p.includes(a.key))&&(r.current.push(a.key),m([...r.current])):(r.current=I(r.current,[a.key]),m([...r.current])))},k=()=>{m([]),r.current=[]};s.useEffect(()=>(e==="click"&&n==="horizontal"&&document.addEventListener("click",k,!1),()=>{e==="click"&&n==="horizontal"&&document.removeEventListener("click",k,!1)}),[]);const A=a=>{var c;return!a||a&&((c=r.current)==null?void 0:c.includes(a.key))},M=a=>a&&a.children?a.children.length*C+(a.childHeight||0):null,b=a=>{const c=a.getAttribute("data-height");c&&(a.style.height=c+"px",a.style.overflow="hidden"),a.style.display=""},y=a=>{a.style.height="",a.style.overflow=""},v=(a,c,p)=>u(T,{in:A(p),timeout:300,onEnter:b,onExit:b,onEntered:y,onExited:y,classNames:"menu",children:u("ul",{className:g("layer-"+c,{"is-child":p}),style:{display:p&&h.includes(p.key)?"block":""},"data-height":M(p),children:a.map(t=>F("li",{className:g(t.className,{disabled:t.disabled,"is-down":h.includes(t.key),selected:t.key===f}),onMouseEnter:()=>w(t),onMouseLeave:()=>_(t),onClick:D.bind(globalThis,t),children:[F("span",{className:"menu-title",children:[u(L,{content:t.label,direction:"right",x:15,disabled:!(c===0&&!t.children&&l.collapse),children:t.icon?u("i",{className:`icon icon-${t.icon}`}):""}),u("span",{className:"name",children:t.label}),t.children?u("i",{className:"icon-arrow"}):""]}),t.children?v(t.children,c+1,t):""]},t.key))})});return u("div",{style:l.style,className:g(`${q}-menu`,n,o,l.className,{collapse:l.collapse&&n==="vertical"}),children:v(l.items,0)})},d=[{label:"\u7528\u6237\u7BA1\u7406",key:"user",icon:"user",children:[{label:"\u7528\u6237\u5217\u8868",key:"aa"},{label:"\u6DFB\u52A0\u7528\u6237",key:"ab"}]},{label:"Navigator Two",key:"b",icon:"search",children:[{label:"item one",key:"b1",children:[{label:"item two",key:"b2"},{label:"item three",key:"b3"}]},{label:"item one",key:"b4"},{label:"item one",key:"b5"}]},{label:"\u7CFB\u7EDF\u8BBE\u7F6E",key:"set",icon:"date",disabled:!0}];function z(){return s.createElement("div",null,s.createElement(i,{items:d,mode:"horizontal"}),s.createElement("p",null,"dark\u4E3B\u9898"),s.createElement(i,{items:d,mode:"horizontal",theme:"dark"}),s.createElement("p",null,"trigger=click"),s.createElement(i,{items:d,mode:"horizontal",trigger:"click"}))}function O(){return s.createElement("div",{style:{width:200}},s.createElement(i,{items:d,mode:"vertical"}),s.createElement("p",null,"dark\u4E3B\u9898"),s.createElement(i,{items:d,mode:"vertical",theme:"dark"}))}function K(){const[l,n]=j.exports.useState(!0),e=o=>{n(o)};return s.createElement("div",{style:{width:200}},s.createElement("div",null,s.createElement(H,{onChange:e,defaultValue:l})),s.createElement(i,{items:d,mode:"vertical",collapse:l}),s.createElement("p",null,"dark\u4E3B\u9898"),s.createElement(i,{items:d,mode:"vertical",theme:"dark",collapse:l}))}function $(l){return s.createElement("div",{className:"doc-container md-pc docs-demo"},s.createElement("div",{className:"code-container"},s.createElement("div",{className:"md-code"}),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:""}})),s.createElement("div",{className:"demo-container"},s.createElement("div",{className:"md-demo"},s.createElement("h1",{id:"menu-\u83DC\u5355\u5BFC\u822A"},"Menu \u83DC\u5355\u5BFC\u822A"),s.createElement("div",{className:"card hide",id:"2358Z4"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u57FA\u672C\u7528\u6CD5">\u57FA\u672C\u7528\u6CD5</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const n=document.getElementById("2358Z4");let e=n.className;n.className.indexOf("show")!==-1?e=n.className.replace("show","hide"):n.className.indexOf("hide")!==-1&&(e=n.className.replace("hide","show")),n.className=e}}))),s.createElement("div",{className:"card hide",id:"V7GWE"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u5782\u76F4\u83DC\u5355">\u5782\u76F4\u83DC\u5355</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const n=document.getElementById("V7GWE");let e=n.className;n.className.indexOf("show")!==-1?e=n.className.replace("show","hide"):n.className.indexOf("hide")!==-1&&(e=n.className.replace("hide","show")),n.className=e}}))),s.createElement("div",{className:"card hide",id:"GDBOPA"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="collapse">Collapse</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const n=document.getElementById("GDBOPA");let e=n.className;n.className.indexOf("show")!==-1?e=n.className.replace("show","hide"):n.className.indexOf("hide")!==-1&&(e=n.className.replace("hide","show")),n.className=e}})))),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:`<h2 id="api">API</h2>
