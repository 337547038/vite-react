...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("EJ3INY");let e=a.className;a.className.indexOf("show")!==-1?e=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(e=a.className.replace("hide","show")),a.className=e}}))),s.createElement("div",{className:"card hide",id:"G8PPH3"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u7981\u7528">\u7981\u7528</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("G8PPH3");let e=a.className;a.className.indexOf("show")!==-1?e=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(e=a.className.replace("hide","show")),a.className=e}}))),s.createElement("div",{className:"card hide",id:"8SKT7Z"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u81EA\u52A8\u9AD8">\u81EA\u52A8\u9AD8</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("8SKT7Z");let e=a.className;a.className.indexOf("show")!==-1?e=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(e=a.className.replace("hide","show")),a.className=e}}))),s.createElement("div",{className:"card hide",id:"50YSPK"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u663E\u793A\u8F93\u5165\u5B57\u6570">\u663E\u793A\u8F93\u5165\u5B57\u6570</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("50YSPK");let e=a.className;a.className.indexOf("show")!==-1?e=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(e=a.className.replace("hide","show")),a.className=e}})))),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:`<h2 id="api">API</h2>
