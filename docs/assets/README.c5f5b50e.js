...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("9FJ8VS");let l=a.className;a.className.indexOf("show")!==-1?l=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(l=a.className.replace("hide","show")),a.className=l}}))),s.createElement("div",{className:"card hide",id:"F2UCD0"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u8868\u5355\u6821\u9A8C">\u8868\u5355\u6821\u9A8C</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("F2UCD0");let l=a.className;a.className.indexOf("show")!==-1?l=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(l=a.className.replace("hide","show")),a.className=l}})))),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:`<h2 id="api">API</h2>
