import{R as s,r as c}from"./index.085b3e07.js";import{M as l}from"./Menu.bd6bd306.js";import"./index.4eedf3c9.js";import"./Tooltip.bf037a8d.js";import"./dom.0e399110.js";import"./CSSTransition.307c8829.js";const t=[{label:"\u7528\u6237\u7BA1\u7406",key:"user",icon:"user",children:[{label:"\u7528\u6237\u5217\u8868",key:"aa"},{label:"\u6DFB\u52A0\u7528\u6237",key:"aa"}]},{label:"Navigator Two",key:"b",icon:"search",children:[{label:"item one",key:"b1",children:[{label:"item two",key:"b2"},{label:"item three",key:"b3"}]},{label:"item one",key:"b4"},{label:"item one",key:"b5"}]},{label:"\u7CFB\u7EDF\u8BBE\u7F6E",key:"set",icon:"date",disabled:!0}];function u(){return s.createElement("div",null,s.createElement(l,{items:t,mode:"horizontal"}),s.createElement("p",null,"dark\u4E3B\u9898"),s.createElement(l,{items:t,mode:"horizontal",theme:"dark"}),s.createElement("p",null,"trigger=click"),s.createElement(l,{items:t,mode:"horizontal",trigger:"click"}))}function r(){return s.createElement("div",{style:{width:200}},s.createElement(l,{items:t,mode:"vertical"}),s.createElement("p",null,"dark\u4E3B\u9898"),s.createElement(l,{items:t,mode:"vertical",theme:"dark"}))}function d(){const[e,a]=c.exports.useState(!0),n=p=>{a(p)};return s.createElement("div",{style:{width:200}},s.createElement("div",null,s.createElement(Switch,{onChange:n,defaultValue:e})),s.createElement(l,{items:t,mode:"vertical",collapse:e}),s.createElement("p",null,"dark\u4E3B\u9898"),s.createElement(l,{items:t,mode:"vertical",theme:"dark",collapse:e}))}function E(e){return s.createElement("div",{className:"doc-container md-pc docs-demo"},s.createElement("div",{className:"code-container"},s.createElement("div",{className:"md-code"}),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:""}})),s.createElement("div",{className:"demo-container"},s.createElement("div",{className:"md-demo"},s.createElement("h1",{id:"menu-\u83DC\u5355\u5BFC\u822A"},"Menu \u83DC\u5355\u5BFC\u822A"),s.createElement("div",{className:"card hide",id:"ANE4GS"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u57FA\u672C\u7528\u6CD5">\u57FA\u672C\u7528\u6CD5</h3>
`}}),s.createElement("div",{className:"demo-block-content"},s.createElement(u,null))),s.createElement("div",{className:"code-block",dangerouslySetInnerHTML:{__html:`<pre><code class="language-jsx"><span class="hljs-keyword">import</span> {Button} from <span class="hljs-string">&#x27;../button&#x27;</span>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("ANE4GS");let n=a.className;a.className.indexOf("show")!==-1?n=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(n=a.className.replace("hide","show")),a.className=n}}))),s.createElement("div",{className:"card hide",id:"2YJDV2"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u5782\u76F4\u83DC\u5355">\u5782\u76F4\u83DC\u5355</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("2YJDV2");let n=a.className;a.className.indexOf("show")!==-1?n=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(n=a.className.replace("hide","show")),a.className=n}}))),s.createElement("div",{className:"card hide",id:"AT9239"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="collapse">Collapse</h3>
`}}),s.createElement("div",{className:"demo-block-content"},s.createElement(d,null))),s.createElement("div",{className:"code-block",dangerouslySetInnerHTML:{__html:`<pre><code class="language-jsx"><span class="hljs-keyword">function</span> <span class="hljs-title function_">Example</span>(<span class="hljs-params"></span>) {
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const a=document.getElementById("AT9239");let n=a.className;a.className.indexOf("show")!==-1?n=a.className.replace("show","hide"):a.className.indexOf("hide")!==-1&&(n=a.className.replace("hide","show")),a.className=n}})))),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:`<h2 id="api">API</h2>
