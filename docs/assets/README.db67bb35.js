var w=Object.defineProperty,_=Object.defineProperties;var v=Object.getOwnPropertyDescriptors;var q=Object.getOwnPropertySymbols;var V=Object.prototype.hasOwnProperty,N=Object.prototype.propertyIsEnumerable;var b=(p,n,t)=>n in p?w(p,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):p[n]=t,C=(p,n)=>{for(var t in n||(n={}))V.call(n,t)&&b(p,t,n[t]);if(q)for(var t of q(n))N.call(n,t)&&b(p,t,n[t]);return p},D=(p,n)=>_(p,v(n));import{r as i,a as A,c as I,p as P,R as s}from"./index.be43aed1.js";import{I as f}from"./Input.eb7ac955.js";import{F as R}from"./contextForm.5ae3f644.js";import{o as S}from"./index.4eedf3c9.js";import{F as e}from"./FormItem.6fc0d948.js";import{B as o}from"./Button.a0bc4897.js";import{C as L}from"./Group.89fccdb2.js";import"./RadioGroup.18d53a6e.js";import"./Option.662c370a.js";import"./SelectDown.c48bba91.js";import"./Tag.033a642a.js";import"./dom.46b1a4a1.js";import"./Switch.e111457f.js";import"./Textarea.fd6141c5.js";import"./DatePicker.2aa3d789.js";const F=i.exports.forwardRef((p,n)=>{const t=i.exports.useRef([]),u=()=>{const l=[];return t.current.forEach(a=>{l.push({prop:a.prop,value:a.getValue()})}),l},m=l=>{let a=[],r=t.current;l&&l.length>0&&(r=t.current.filter(x=>l.indexOf(x.prop)!==-1));const y=[];return new Promise((x,k)=>{r.forEach(j=>{j.validate().then(()=>{a.push("true"),B()}).catch(E=>{a.push(E),B()}),y.push({prop:j.prop,value:j.getValue()})});const B=()=>{if(a.length===r.length){const j=a.filter(E=>E!=="true");j.length>0?k(j):x(y)}}})},h=l=>{t.current.forEach(a=>{l&&(l==null?void 0:l.length)>0?l.includes(a.prop)&&a.clearTips():a.clearTips()})},g=()=>{console.log("\u6062\u590D\u521D\u59CB\u503C\u5F00\u53D1\u4E2D..."),h()};i.exports.useImperativeHandle(n,()=>({getValue:u,validate:m,clearValidate:h,resetForm:g,setValue:d}));const c=S(p,["children","className"]);c.callback=l=>{t.current.push(l)},c.onChange=(l,a)=>{p.onChange&&p.onChange(l,a)};const d=l=>{console.log("\u5F00\u53D1\u4E2D..."),console.log(l),c.setValue=l};return A(R.Provider,{value:c,children:A("form",{className:I(`${P}-form`,p.className),children:p.children})})});F.displayName="Form";F.defaultProps={showMessage:!0,required:!0,trigger:"change",rules:{}};function T(){const[p,n]=i.exports.useState({userName:"userName",password:"passwordValue",password2:"passwordValue"}),t={password:[{type:"required",msg:"\u5BC6\u7801\u4E0D\u80FD\u4E3A\u7A7A"},{type:"minLength",len:6,msg:"\u5BC6\u7801\u4E0D\u80FD\u5C0F\u4E8E6\u4F4D"}],password2:[{type:"required",msg:"\u5BC6\u78012\u4E0D\u80FD\u4E3A\u7A7A"},{type:"fn",msg:"\u4E24\u6B21\u8F93\u5165\u7684\u5BC6\u7801\u4E0D\u4E00\u81F4",validator:a=>a===p.password}],userName:[{type:"required",msg:"\u7528\u6237\u540D\u4E0D\u80FD\u4E3A\u7A7A"}]},u=i.exports.useRef(null),m=()=>{var a;(a=u.current)==null||a.validate().then(r=>{console.log(r)}).catch(r=>{console.log(r)})},h=()=>{var a;(a=u.current)==null||a.resetForm()},g=()=>{var a;console.log((a=u.current)==null?void 0:a.getValue())},c=()=>{var a;console.log((a=u.current)==null?void 0:a.setValue({}))},d=a=>{n(D(C({},p),{password:a}))},l=(a,r)=>{console.log(a),console.log(r)};return s.createElement("div",{className:"form-demo"},s.createElement(F,{rules:t,ref:u,onChange:l},s.createElement(e,{label:"userName",prop:"userName",type:"input",defaultValue:p.userName,data:{placeholder:"\u8BF7\u8F93\u5165\u7528\u6237\u540D"}}),s.createElement(e,{label:"password",prop:"password"},s.createElement(f,{defaultValue:p.password,placeholder:"\u8BF7\u8F93\u5165\u5BC6\u7801",onChange:d})),s.createElement(e,{label:"password2",prop:"password2"},s.createElement(f,{defaultValue:p.password2,placeholder:"\u8BF7\u518D\u6B21\u8F93\u5165\u5BC6\u7801"}))),s.createElement(o,{onClick:m,type:"primary"},"submit"),s.createElement(o,{onClick:h},"reset"),s.createElement(o,{onClick:g},"getValue"),s.createElement(o,{onClick:c},"setValue"))}function M(){const p={userName:"userName",number:"100.00",switch:!1},n=i.exports.useRef(null),t=[{label:"\u9009\u98791",value:"1"},{label:"\u9009\u98792",value:"2"},{label:"\u9009\u98793",value:"3"}],u={password:[{type:"required",msg:"\u5BC6\u7801\u4E0D\u80FD\u4E3A\u7A7A"},{type:"minLength",len:6,msg:"\u5BC6\u7801\u4E0D\u80FD\u5C0F\u4E8E6\u4F4D"}],userName:[{type:"required",msg:"\u7528\u6237\u540D\u4E0D\u80FD\u4E3A\u7A7A"}],mobile:[{type:"required",msg:"\u8BF7\u8F93\u5165\u624B\u673A\u53F7"},{type:"mobile",msg:"\u624B\u673A\u53F7\u683C\u5F0F\u4E0D\u6B63\u786E"}],mail:[{type:"mail",msg:"\u90AE\u7BB1\u683C\u5F0F\u4E0D\u6B63\u786E"}],digits:[{type:"digits",msg:"\u53EA\u80FD\u8F93\u5165\u6B63\u6574\u6570"}],number:[{type:"number",msg:"\u53EA\u80FD\u8F93\u5165\u6570\u5B57"}],tel:[{type:"tel",msg:"\u7535\u8BDD\u53F7\u7801\u683C\u5F0F\u4E0D\u6B63\u786E"}],city:[{type:"required",msg:"\u57CE\u5E02\u4E0D\u80FD\u4E3A\u7A7A"}],area:[{type:"required",msg:"\u5730\u533A\u4E0D\u80FD\u4E3A\u7A7A"}],select:[{type:"required",msg:"\u4E0B\u62C9\u4E0D\u80FD\u4E3A\u7A7A"}],checkbox:[{type:"required",msg:"\u5FC5\u987B\u540C\u610F\u534F\u8BAE"}],checkboxGroup:[{type:"required",msg:"\u4E0D\u80FD\u4E3A\u7A7A"}],textarea:[{type:"required",msg:"textarea\u4E0D\u80FD\u4E3A\u7A7A"}],radio:[{type:"required",msg:"radio\u4E0D\u80FD\u4E3A\u7A7A"}],datePicker:[{type:"required",msg:"\u8BF7\u9009\u62E9\u65E5\u671F"}]},m=()=>{var l;(l=n.current)==null||l.resetForm()},h=()=>{var l;(l=n.current)==null||l.validate().then(a=>{console.log(a)}).catch(a=>{console.log(a)})},g=()=>{var l;(l=n.current)==null||l.validate(["userName","password"]).then(a=>{alert("\u9A8C\u8BC1\u901A\u8FC7"),console.log(a)}).catch(a=>{alert(a),console.log(a)})},c=()=>{var l;console.log((l=n.current)==null?void 0:l.getValue())},d=(l,a)=>{console.log(l),console.log(a)};return s.createElement("div",{className:"form-demo"},s.createElement(F,{ref:n,rules:u,size:"mini",onChange:d,labelWidth:"150px"},s.createElement(e,{label:"\u7528\u6237\u540D",prop:"userName"},s.createElement(f,{defaultValue:p.userName,placeholder:"\u8BF7\u8F93\u5165\u7528\u6237\u540D"})),s.createElement(e,{label:"\u5BC6\u7801",prop:"password",type:"input",data:{type:"password",placeholder:"\u8BF7\u8F93\u5165\u5BC6\u7801"}}),s.createElement(e,{prop:"mobile",label:"\u624B\u673A\u53F7",type:"input",data:{placeholder:"\u8BF7\u8F93\u5165\u624B\u673A\u53F7"}}),s.createElement(e,{prop:"mail",label:"\u90AE\u7BB1",type:"input",data:{placeholder:"\u8BF7\u8F93\u5165\u90AE\u7BB1\u5730\u5740"}}),s.createElement(e,{prop:"digits",label:"digits",type:"input"}),s.createElement(e,{prop:"number",label:"number",type:"input",defaultValue:p.number}),s.createElement(e,{prop:"tel",label:"tel",type:"input",data:{placeholder:"\u8BF7\u8F93\u5165\u7535\u8BDD\u53F7\u7801"}}),s.createElement(e,{label:"\u57CE\u5E02"},s.createElement(e,{prop:"city",type:"input"}),s.createElement(e,{prop:"area",type:"input"})),s.createElement(e,{label:"radio",prop:"radio",type:"radio",data:{options:t}}),s.createElement(e,{label:"checkbox",prop:"checkboxGroup",type:"checkbox",data:{options:t}}),s.createElement(e,{prop:"select",label:"select",type:"select",data:{options:t,clear:!0,placeholder:"\u8BF7\u9009\u62E9"}}),s.createElement(e,{label:"textarea",prop:"textarea",type:"textarea"}),s.createElement(e,{label:"switch",type:"switch",prop:"switch",defaultValue:p.switch}),s.createElement(e,{label:"datePicker",type:"datePicker",prop:"datePicker",defaultValue:p.datePicker,data:{placeholder:"\u8BF7\u9009\u62E9\u65F6\u95F4"}}),s.createElement(e,{prop:"checkbox"},s.createElement(L,{value:"formValue.checkbox"},"\u6211\u5DF2\u9605\u8BFB\u5E76\u540C\u610F\u2026\u2026")),s.createElement(o,{type:"primary",onClick:h},"\u63D0\u4EA4"),s.createElement(o,{type:"primary",onClick:g}," \u4EC5\u5BF9\u7528\u6237\u540D\u5BC6\u7801\u9A8C\u8BC1 "),s.createElement(o,{onClick:m}," \u91CD\u7F6E\u8868\u5355 "),s.createElement(o,{onClick:c}," \u83B7\u53D6\u8868\u5355\u503C ")))}function ls(p){return s.createElement("div",{className:"doc-container md-pc docs-demo"},s.createElement("div",{className:"code-container"},s.createElement("div",{className:"md-code"}),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:""}})),s.createElement("div",{className:"demo-container"},s.createElement("div",{className:"md-demo"},s.createElement("h1",{id:"form-\u8868\u5355"},"Form \u8868\u5355"),s.createElement("div",{className:"card hide",id:"9J3892"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u57FA\u672C\u4F7F\u7528">\u57FA\u672C\u4F7F\u7528</h3>
...
<span class="hljs-keyword">import</span> <span class="hljs-keyword">type</span> {<span class="hljs-title class_">FormRef</span>} <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;./index&#x27;</span>
...
<span class="hljs-keyword">function</span> <span class="hljs-title function_">Example</span>(<span class="hljs-params"></span>) {
  ...
  <span class="hljs-keyword">return</span> (<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">className</span>=<span class="hljs-string">&#x27;form-demo&#x27;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">Form</span> <span class="hljs-attr">rules</span>=<span class="hljs-string">{formRules}</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">{formEl}</span> <span class="hljs-attr">onChange</span>=<span class="hljs-string">{formOnChange}</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">FormItem</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;userName&quot;</span> <span class="hljs-attr">prop</span>=<span class="hljs-string">&quot;userName&quot;</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&#x27;input&#x27;</span> <span class="hljs-attr">defaultValue</span>=<span class="hljs-string">{formValue.userName}</span>
                <span class="hljs-attr">data</span>=<span class="hljs-string">{{placeholder:</span> &quot;\u8BF7\u8F93\u5165\u7528\u6237\u540D&quot;}}&gt;</span>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const n=document.getElementById("9J3892");let t=n.className;n.className.indexOf("show")!==-1?t=n.className.replace("show","hide"):n.className.indexOf("hide")!==-1&&(t=n.className.replace("hide","show")),n.className=t}}))),s.createElement("div",{className:"card hide",id:"BLGSDN"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u8868\u5355\u6821\u9A8C">\u8868\u5355\u6821\u9A8C</h3>
...
<span class="hljs-keyword">function</span> <span class="hljs-title function_">Example</span>(<span class="hljs-params"></span>) {
  ...
  <span class="hljs-keyword">const</span> formRules = {
    ...
    <span class="hljs-comment">/*timePicker: [{type: &#x27;required&#x27;, msg: &#x27;\u8BF7\u9009\u62E9\u65F6\u95F4&#x27;}],
  ...
  <span class="hljs-keyword">return</span> (<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">className</span>=<span class="hljs-string">&#x27;form-demo&#x27;</span>&gt;</span>
      ...
      <span class="hljs-tag">&lt;/<span class="hljs-name">FormItem</span>&gt;</span>*/}
        ...
        <span class="hljs-tag">&lt;<span class="hljs-name">FormItem</span> <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;datePicker&quot;</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&#x27;datePicker&#x27;</span> <span class="hljs-attr">prop</span>=<span class="hljs-string">&#x27;datePicker&#x27;</span> <span class="hljs-attr">defaultValue</span>=<span class="hljs-string">{formValue.datePicker}</span>
                  <span class="hljs-attr">data</span>=<span class="hljs-string">{{placeholder:</span> &#x27;\u8BF7\u9009\u62E9\u65F6\u95F4&#x27;}} /&gt;</span>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const n=document.getElementById("BLGSDN");let t=n.className;n.className.indexOf("show")!==-1?t=n.className.replace("show","hide"):n.className.indexOf("hide")!==-1&&(t=n.className.replace("hide","show")),n.className=t}})))),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:`<h2 id="api">API</h2>
