...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const n=document.getElementById("D0QO2O");let t=n.className;n.className.indexOf("show")!==-1?t=n.className.replace("show","hide"):n.className.indexOf("hide")!==-1&&(t=n.className.replace("hide","show")),n.className=t}}))),s.createElement("div",{className:"card hide",id:"8POU8V"},s.createElement("div",{className:"demo-block"},s.createElement("div",{className:"demo-block-title",dangerouslySetInnerHTML:{__html:`<h3 id="\u8868\u5355\u6821\u9A8C">\u8868\u5355\u6821\u9A8C</h3>
...
`}}),s.createElement("div",{className:"control-block"},s.createElement("span",{onClick:()=>{const n=document.getElementById("8POU8V");let t=n.className;n.className.indexOf("show")!==-1?t=n.className.replace("show","hide"):n.className.indexOf("hide")!==-1&&(t=n.className.replace("hide","show")),n.className=t}})))),s.createElement("div",{className:"md-api",dangerouslySetInnerHTML:{__html:`<h2 id="api">API</h2>
